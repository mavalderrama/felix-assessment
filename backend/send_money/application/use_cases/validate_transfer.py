...
class ValidateTransferUseCase:
    ...
    async def execute(self, draft_dict: dict[str, Any]) -> TransferDraft:
        ...
        # Corridor check
        country = draft.destination_country or ""
        ...
        rate = await self._fx.get_rate(
            source_currency, dest_currency or source_currency
        )
        send_money = Money(
        ...
        receive_money = Money.from_decimal(
            receive_decimal, dest_currency or source_currency
        )
