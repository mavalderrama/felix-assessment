...
def test_beneficiary_stores_fields():
    b = Beneficiary(
        id="uuid-1",
        user_id="user-1",
        name="Maria Garcia",
...
def test_beneficiary_account_in_transfer_draft_missing_fields():
    draft = TransferDraft(
        destination_country="MX",
        amount_units=100,
        amount_currency="USD",
...
def test_transfer_draft_complete_with_beneficiary_account():
    draft = _complete_draft()
    assert draft.is_complete is True
