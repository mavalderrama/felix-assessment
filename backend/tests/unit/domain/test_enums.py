...
class TestCountryDisplayName:
    ...
    def test_colombia(self) -> None:
        assert Country.CO.display_name == "Colombia"

    def test_guatemala(self) -> None:
        assert Country.GT.display_name == "Guatemala"

    def test_philippines(self) -> None:
    ...
    def test_all_countries_have_display_name(self) -> None:
...
class TestFormatCountry:
    def test_known_code_includes_name_and_code(self) -> None:
        assert format_country("MX") == "Mexico (MX)"

    def test_known_code_gb(self) -> None:
        assert format_country("GB") == "United Kingdom (GB)"

    def test_unknown_code_returns_bare_code(self) -> None:
        assert format_country("XX") == "XX"

    def test_all_enum_values_format_correctly(self) -> None:
        for country in Country:
...
class TestCurrencyNamesCompleteness:
    ...
    def test_all_seeded_currencies_present(self) -> None:
