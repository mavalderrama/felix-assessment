...
def test_decimal_to_money_whole() -> None:
...
def test_decimal_to_money_fractional() -> None:
    m = decimal_to_money(Decimal("9.99"), "EUR")
    assert m.units == 9
    assert m.nanos == 990_000_000


def test_money_to_decimal_round_trip() -> None:
...
def test_money_to_dict_and_back() -> None:
...
def test_dict_to_money_string_units() -> None:
...
def test_money_to_proto_round_trip() -> None:
...
def test_decimal_to_proto_round_trip() -> None:
...
def test_no_float_rounding_in_conversion() -> None:
